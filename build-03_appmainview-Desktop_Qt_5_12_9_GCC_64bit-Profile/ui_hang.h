...
""));
        ...
        curtain->setIcon(icon2);
        curtain->setIconSize(QSize(80, 80));
        curtain->setCheckable(false);
...
"}"));
    ...
    void retranslateUi(QWidget *hang)
    {
        ...
        curtain->setText(QApplication::translate("hang", "\347\251\272\350\260\203", nullptr));
