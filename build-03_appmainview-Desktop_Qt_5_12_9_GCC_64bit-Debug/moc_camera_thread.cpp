...
#include "../appdemo/camera_thread.h"
...
void camera_thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&camera_thread::imageReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void camera_thread::imageReady(QImage _t1)
{
